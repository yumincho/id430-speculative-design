...
export const articlesWhiteData: Record<string, ArticleData> = {
  "article-1": {
    ...
    aiSummary:
      "이정화, 김태훈 부부는 아이와의 소통에서 inTone을 활용합니다. 그들은 따뜻한 부모의 마음을 inTone을 통해 아이에게 전합니다.",
  },
  "article-2": {
    id: "article-2",
    title: "아이들과 더 나은 미래로",
    ...
    aiSummary:
      "싱가포르의 한 초등학교 2학년 교실에서 inTone Edu를 활용하여 아이들의 말하기 능력을 향상시키는 사례를 다룹니다. 아이들은 더 자신감 있고 따뜻한 소통을 하게 되며, 교실의 분위기도 긍정적으로 변화합니다.",
  },
  "article-3": {
    id: "article-3",
    ...
    aiSummary:
      "DalnaSays는 2년 전 첫 영상을 올린 후, 이제는 200만 구독자를 가진 유튜버로 성장했습니다. 그는 inTone을 통해 자신감을 얻고, 개성 있는 말투로 많은 사람들과 소통하게 되었습니다.",
  },
  "article-4": {
    id: "article-4",
    ...
    aiSummary:
      "정수찬 씨는 중학교를 졸업한 후, 오랫동안 평범한 월급쟁이로 살았습니다. 그러나 inTone을 통해 말하는 자신감을 얻고, IR 피치, 언론 인터뷰, 해외 컨퍼런스 발표 등 다양한 분야에서 활발히 활동하게 되었습니다.",
  },
};
