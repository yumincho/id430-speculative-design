...
export const article4 = (
  <ArticleWrapper>
    <H2>
      “사람들은 제가 글도 잘 쓰고, 말도 잘 한다고 해요. 
      <br/>
      사실은 그 둘 다 제가 못했던 것들이에요. 
      <br/>
      그런데 생각만은, 예전부터 언제나 저한테 있었어요. 이제야 그걸 말할 수 있게 된 것뿐이에요.”
    </H2>
    <br />
    <Text>
      삼십여 년 전, <Strong>정수찬(코일낫 대표, 46)</Strong> 씨는 중학교를 겨우 졸업했다.
    ...
    <Quote>
      “입을 여는 순간, 새로운 세상을 마주했죠. 이때까지 제 머릿속에만 있던 것들이 제 말투, 제 목소리 그대로, 드디어 바깥으로 나온거예요.”
    </Quote>
    <Text>
      이제는 넘쳐 흐르는 생각을 거리낌없이 말하고 쓰고 다시 듣는다. 
      그러면 inTone이 말을 정리해주고, 그는 그 결과에서 다시 생각을 이어간다. 말과 생각이 맞물려 흐르는 구조, 그건 예전의 그에게 없던 감각이었다.
    </Text>
    <Text>
      하지만 그가 첫 IR 피치 무대에 섰을 때, 투자자 중 한 사람이 이렇게 말했다.
      <br />
      <Strong>
      “정 대표님, 말씀 참 잘하시네요. 믿음직스러운데다가, 기억에 남아요. 교양이 정말 대단하시네요.”
      </Strong>
    </Text>
    <Text>
    ...
    <Text>
      지금 그는 투자자 미팅과 언론 인터뷰는 물론, 해외 스타트업 컨퍼런스에서 영어로 직접 발표도 한다. 
      inTone은 실시간 통역과 문장 리포맷 기능까지 탑재되어 있어, 그가 평소 쓰는 키워드와 화법을 학습해 더 자연스러운 표현으로 전달해준다. 
      <br />
      <br />
      <Strong>
        영어로 말해도 여전히 정수찬의 말인 것이다.
      </Strong>
    </Text>
    <Quote>
    ...
    <Quote>
      “문장이 바뀌니까 말투가 바뀌었고, 말투가 바뀌니까 사람들이 날 받아들이는 방식이 완전히 달라졌어요. 
      inTone 덕분에 대화라는 장에 처음으로 초대받은 기분이었어요. 그게 얼마나 큰 일인지… 겪어보지 않으면 잘 몰라요.”
    </Quote>
    <Text>
